		...
		<div class="row">
			...
			<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
				...
				<div class="panel panel-default">
					<div class="panel-body">
						<h4>
							<h style="color:black;"><strong>${chef.nickname }님의 팔로워</strong></h>
						</h4>
						<hr>
					                ...
					                <div class="col-md-4">
					                	<div class="artist-data pull-left">
					                    	<div class="artst-pic pull-left">
					                    		<a href="${pageContext.request.contextPath}/userpage/main?chef_no=${followedList.chef_no}">
					                    			<img src="${followedList.profile}" alt="" class="img-responsive" width="100px" height="100px" style = "border-radius: 10px;" />
					                    		</a>
					                    	</div>
					                        <div class="artst-prfle pull-right">
					                        	<div class="art-title">
					                            	<a href="${pageContext.request.contextPath}/userpage/main?chef_no=${followedList.chef_no}" style="font-size:12px; color:black;"><Strong>${followedList.nickname }</Strong></a>
					                            	<br>
					                            	<h style="font-size:10px; color:gray;">${followedList.self_intro }</h>
					                            </div>
					                            <div class="counter-tab">
					                            	<span class="artst-like"><a href="${pageContext.request.contextPath}/userpage/followinglist?chef_no=${followedList.chef_no}"><i class="glyphicon glyphicon-heart-empty"></i>${followedList.followed_count }</a></span>
					                            </div>
					                        </div>
					                    </div>
					                </div>
